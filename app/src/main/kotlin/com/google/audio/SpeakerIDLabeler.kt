 ...
 */
interface SpeakerIDLabeler : SampleProcessorInterface {
    /**
     ...
     */
    fun setReferenceTimestamp(now: Instant?)
     ...
     * be very inexpensive.
     */
    fun getSpeakerIDForTimeInterval(start: Instant?, end: Instant?): SpeakerIdInfo?
